  ...
  public:
        ...
        , m_statesMap(make_states_map(rootState))
    {
        ...
        static_assert(
            ...
            "At least one initial state of the state machine has sub states/transition tables. "
            "This is not allowed.");
        static_assert(
            bh::not_(at_least_one_initial_state_has_internal_transition_table(rootState)),
            "At least one initial state of the state machine has internal transition tables. This "
            "is not allowed.");
